...
const configValidation = joi
    ...
    .keys({
        ...
        KAFKA_TOPIC_EMAIL: joi.string().required(),
        KAFKA_GROUP_ID: joi.string().required(),
        KAFKA_GROUP_ID_EMAIL: joi.string().required(),
...
export const config = {
    ...
    KAFKA_TOPIC_EMAIL: envVariables.KAFKA_TOPIC_EMAIL,
    KAFKA_GROUP_ID: envVariables.KAFKA_GROUP_ID,
    KAFKA_GROUP_ID_EMAIL: envVariables.KAFKA_GROUP_ID_EMAIL,
